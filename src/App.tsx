              ...
              <Route element={<ProtectedRoute role="TENANT" />}>
                ...
                >
                  <Route path="/tenant" element={<AppShell role="TENANT" />}>
                    ...
                    {/* Saved entries belong to the account and remain readable
                    after a browsing pass expires. Opening a listing is still
                    protected by the catalogue gate below. */}
                    <Route path="favorites" element={<TenantFavourites />} />

                    {/* The catalogue. These three are exactly what
