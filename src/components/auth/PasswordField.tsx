 ...
 * the tab order: keyboard users tabbing between password and confirm shouldn't
 * have to pass through it, and the field is reachable by click or by the label.
 */
