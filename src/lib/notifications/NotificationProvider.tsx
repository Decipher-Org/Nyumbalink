/**
 * Notification state for the app shell: the unread count displayed in the bell.
 *
 ...
 * receipts, property views). The full notification page always fetches the
...
import { currentPushState, enablePushNotifications } from "@/lib/notifications/push";
